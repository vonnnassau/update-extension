...
var config = {
  ...
  panels: [{
    ...
    name: "main",
    panelDisplayName: "Update Extension",
    autoVisible: true,
    width: 600,
    height: 650
  }],
...
var helloWorld$8 = function helloWorld() {
  ...
  app.beginUndoGroup("Create Comp and Text Layer");
  var compName = "Hello World Comp";
  var compWidth = 1920;
  var compHeight = 1080;
  var compPixelAspect = 1.0;
  var compDuration = 10; // in seconds
  var compFrameRate = 30;
  var comp = app.project.items.addComp(compName, compWidth, compHeight, compPixelAspect, compDuration, compFrameRate);
  var textLayer = comp.layers.addText("Hello Martians123");
  textLayer.name = "Hello World Text Layer";
